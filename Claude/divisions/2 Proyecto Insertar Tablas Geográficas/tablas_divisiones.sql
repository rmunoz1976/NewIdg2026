...
DROP TABLE IF EXISTS `t054c_currency_type`;

CREATE TABLE `t054c_currency_type` (
  `id` int NOT NULL AUTO_INCREMENT COMMENT 'Consecutivo único del registro',
  `iso_4217_code` varchar(16) NOT NULL COMMENT 'Código ISO 4217 del tipo de moneda',
  `description` varchar(64) NOT NULL COMMENT 'Descripción del tipo de moneda',
  `symbol` varchar(8) NOT NULL COMMENT 'Símbolo del tipo de moneda',
  `thousands_separator` varchar(2) NOT NULL COMMENT 'Separador de miles del tipo de moneda',
  `decimal_separator` varchar(2) NOT NULL COMMENT 'Separador de decimales del tipo de moneda',
  `decimal_places` int NOT NULL COMMENT 'Cantidad de decimales del tipo de moneda',
  `symbol_position` varchar(16) NOT NULL COMMENT 'Posición del símbolo en el valor del tipo de moneda',
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `CHK_NE_t054c_decimal_separator` CHECK ((`decimal_separator` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t054c_description` CHECK ((`description` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t054c_iso_4217_code` CHECK ((`iso_4217_code` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t054c_symbol` CHECK ((`symbol` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t054c_symbol_position` CHECK ((`symbol_position` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t054c_thousands_separator` CHECK ((`thousands_separator` <> _utf8mb4''))
...
CREATE TABLE `t070t_divisions` (
  ...
  `name_spanish` varchar(128) NOT NULL COMMENT 'Nombre del tipo geográfico en español',
  `name_english` varchar(128) NOT NULL COMMENT 'Nombre del tipo geográfico en inglés',
  `name_iso` varchar(128) NOT NULL COMMENT 'Nombre oficial ISO del tipo geográfico',
  `name_original` varchar(128) NOT NULL COMMENT 'Nombre del tipo geográfico en idioma oficial',
  `name_transcribed` varchar(128) NOT NULL COMMENT 'Nombre del tipo geográfico transcrito a alfabeto latino legible',
  ...
  CONSTRAINT `CHK_NE_t070t_name_english` CHECK ((`name_english` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t070t_name_spanish` CHECK ((`name_spanish` <> _utf8mb4''))
...
CREATE TABLE `t074t_countries` (
  ...
  `name_spanish` varchar(128) NOT NULL COMMENT 'Nombre del país en español',
  `name_english` varchar(128) NOT NULL COMMENT 'Nombre del país en inglés',
  `name_iso` varchar(128) NOT NULL COMMENT 'Nombre oficial ISO del país',
  `name_original` varchar(128) NOT NULL COMMENT 'Nombre del país en idioma oficial',
  `name_transcribed` varchar(128) NOT NULL COMMENT 'Nombre del país transcrito a alfabeto latino legible',
  ...
  KEY `IDX_t074t_name_spanish` (`name_spanish`),
  KEY `IDX_t074t_name_english` (`name_english`),
  ...
  CONSTRAINT `CHK_NE_t074t_name_english` CHECK ((`name_english` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t074t_name_spanish` CHECK ((`name_spanish` <> _utf8mb4'')),
...
CREATE TABLE `t076t_states` (
  ...
  `name_spanish` varchar(128) NOT NULL COMMENT 'Nombre del departamento en español',
  `name_english` varchar(128) NOT NULL COMMENT 'Nombre del departamento en inglés',
  `name_iso` varchar(128) NOT NULL COMMENT 'Nombre oficial ISO del departamento',
  `name_original` varchar(128) NOT NULL COMMENT 'Nombre del departamento en idioma oficial',
  `name_transcribed` varchar(128) NOT NULL COMMENT 'Nombre del departamento transcrito a alfabeto latino legible',
  `status` int NOT NULL DEFAULT '1' COMMENT 'Estado del registro: 1=activo, 0=inactivo',
  `created_at` datetime(6) NOT NULL COMMENT 'Fecha y hora de creación del registro',
  `updated_at` datetime(6) NOT NULL COMMENT 'Fecha y hora de última actualización del registro',
  `created_by` int NOT NULL COMMENT 'Usuario que creó el registro',
  ...
  KEY `IDX_t076t_name_spanish` (`name_spanish`),
  KEY `IDX_t076t_name_english` (`name_english`),
  KEY `IDX_t076t_id_country` (`id_country`),
  KEY `IDX_t076t_code` (`code`),
  KEY `IDX_t076t_id_geo_type` (`id_geo_type`),
  KEY `IDX_t076t_id_country_name` (`id_country`,`name_spanish`),
  ...
  CONSTRAINT `CHK_NE_t076t_name_english` CHECK ((`name_english` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t076t_name_spanish` CHECK ((`name_spanish` <> _utf8mb4'')),
...
CREATE TABLE `t078t_municipalities` (
  ...
  `id_geo_type` int NOT NULL COMMENT 'Identificador del tipo de división geográfica',
  `name_spanish` varchar(128) NOT NULL COMMENT 'Nombre del municipio en español',
  `name_english` varchar(128) NOT NULL COMMENT 'Nombre del municipio en inglés',
  `name_iso` varchar(128) NOT NULL COMMENT 'Nombre oficial ISO del municipio',
  `name_original` varchar(128) NOT NULL COMMENT 'Nombre del municipio en idioma oficial',
  `name_transcribed` varchar(128) NOT NULL COMMENT 'Nombre del municipio transcrito a alfabeto latino legible',
  ...
  KEY `IDX_t078t_name_spanish` (`name_spanish`),
  KEY `IDX_t078t_name_english` (`name_english`),
  ...
  KEY `IDX_t078t_id_country_state_name` (`id_country`,`id_state`,`name_spanish`),
  ...
  CONSTRAINT `CHK_NE_t078t_name_english` CHECK ((`name_english` <> _utf8mb4'')),
  CONSTRAINT `CHK_NE_t078t_name_spanish` CHECK ((`name_spanish` <> _utf8mb4'')),
