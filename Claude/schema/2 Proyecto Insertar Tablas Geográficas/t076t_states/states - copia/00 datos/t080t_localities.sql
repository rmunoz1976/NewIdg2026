CREATE TABLE `t080t_localities` (
  ...
  `id_division_type` int NOT NULL COMMENT 'Identificador del tipo de subdivisión geográfica',
  ...
  PRIMARY KEY (`id`),
  KEY `IDX_t080t_name_spanish` (`name_spanish`),
  ...
  KEY `IDX_t080t_id_muni_name` (`id_municipality`,`name_spanish`),
  KEY `IDX_t080t_id_division_type` (`id_division_type`),
  ...
  CONSTRAINT `FK_t080t_id_division_type_t070t` FOREIGN KEY (`id_division_type`) REFERENCES `t070t_division_type` (`id`),
  ...
  CONSTRAINT `CHK_NE_t080t_name_spanish` CHECK ((`name_spanish` <> _utf8mb4''))
